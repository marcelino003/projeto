...
export class BuyappalertPage implements OnInit {
  ...
  buyAppAction() {
    this.modalController.dismiss();
    window.open("https://dashboard.vtlabs.dev/projects/envato-referral-buy-link?project_slug=myBanking_ionic", '_system', 'location=no');
  }
 
  navWhatsapp() {
    let projectName = "myBanking_ionic";
